...
public class Aims {
	...
	private static void addDisc(Order anOrder, Scanner input) throws Exception  {
		int id;
		DigitalVideoDisc disc = null;
		do {
		...
		try {
			disc = new DigitalVideoDisc(title, category, director, length, cost, id);
	...
	private static void addBook(Order anOrder, Scanner input) throws Exception  {
		int id;
		do {
			System.out.println("Enter ID: ");
			id = input.nextInt();
	...
	private static void addCompactDisc(Order anOrder, Scanner input) throws Exception {
		int id;
		CompactDisc cd = null;
		do {
			System.out.println("Enter ID: ");
