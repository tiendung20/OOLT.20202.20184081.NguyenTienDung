...
public class Order {
	...
	public Order() throws Exception {
		if (nbOrders >= MAX_LIMITTED_ORDERS) {
			...
			throw new Exception("The list of orders is full.");
		}
		else {
	...
	public void addMedia(Media media) throws LimitExceededException {
		if (itemsOrdered.size() >=10) {
			...
			throw new LimitExceededException("The order list is full");
		}
		else {
	...
	public void addMedia(Media media1, Media media2) throws LimitExceededException {
		if (itemsOrdered.size() >= 10) {
			...
			throw new LimitExceededException("Not enough slot for these items.");
		}
		else {
